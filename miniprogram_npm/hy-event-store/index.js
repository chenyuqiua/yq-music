...
__DEFINE__(1661089924331, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1661089924332,"./event-store":1661089924333}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1661089924332, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1661089924333, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1661089924332,"./utils":1661089924334}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1661089924334, function(require, module, exports) {
...
return __REQUIRE__(1661089924331);
})()
